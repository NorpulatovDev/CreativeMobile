...
import '../bloc/payments_page_cubit.dart';
      ...
      child: BlocProvider(
        ...
        child: Builder(
          builder: (context) => BlocProvider(
            create: (_) => PaymentsPageCubit(context.read<PaymentBloc>()),
      ...
      body: CustomScrollView(
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Container(
                ...
                child: BlocBuilder<PaymentsPageCubit, String>(
                  builder: (context, query) => TextField(
                    controller: _searchController,
                    onChanged: context.read<PaymentsPageCubit>().onQueryChanged,
                      ...
                      suffixIcon: query.isNotEmpty
                          ? IconButton(
                              ...
                              onPressed: () {
                                ...
                                context.read<PaymentsPageCubit>().clear();
                              },
                            )
                          : null,
          ...
          BlocConsumer<PaymentBloc, PaymentState>(
            listenWhen: (_, curr) => curr is PaymentError || curr is PaymentActionSuccess,
            buildWhen: (_, curr) => curr is! PaymentActionSuccess,
              ...
              if (state is PaymentLoaded) {
                if (state.payments.isEmpty) {
                  return SliverFillRemaining(
                    child: context.read<PaymentsPageCubit>().state.isEmpty
      ...
      child: Column(
        ...
        children: [
          Container(
            padding: const EdgeInsets.all(24),
            decoration: BoxDecoration(
                color: AppColors.neutral100, shape: BoxShape.circle),
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 52,
            decoration: BoxDecoration(
              color: _avatarColor(payment.studentName).withValues(alpha: 0.1),
              borderRadius: BorderRadius.circular(16),
            ),
            child: Center(
              child: Text(
                ...
                style: TextStyle(
                    fontSize: 20,
                    fontWeight: FontWeight.w700,
                    color: _avatarColor(payment.studentName)),
              ),
            ),
          ),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '${payment.studentName}ning ${payment.paidForMonth} oyi uchun to\'lovini o\'chirishni xohlaysizmi?',
