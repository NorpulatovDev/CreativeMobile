...
class _$AttendanceImpl implements _Attendance {
  ...
  @override
  String toString() {
    return 'Attendance(id: $id, date: $date, studentId: $studentId, studentName: $studentName, groupId: $groupId, groupName: $groupName, status: $status, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
