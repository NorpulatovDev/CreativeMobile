...
import '../../features/sms/presentation/pages/pending_sms_page.dart';
        ...
        branches: [
          ...
          StatefulShellBranch(
            routes: [
              ...
              GoRoute(
                path: Routes.pendingSms,
                name: 'pending-sms',
                builder: (context, state) => const PendingSmsPage(),
              ),
            ],
          ),
          // Branch 1 — Groups
...
class _PageGrid extends StatelessWidget {
  ...
  List<_PageData> _buildItems(BuildContext context) {
    return [
      ...
      _PageData(icon: Icons.outgoing_mail,          label: "Kutilayotgan SMS",  color: const Color(0xFF6366F1), route: Routes.pendingSms),
